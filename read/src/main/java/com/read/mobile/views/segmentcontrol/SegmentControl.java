package com.read.mobile.views.segmentcontrol;
...
public class SegmentControl extends View {
	...
	public SegmentControl(Context context, AttributeSet attrs, int defStyle) {
		...
		int gap = ta.getDimensionPixelSize(R.styleable.SegmentControl_gaps, (int) TypedValue.applyDimension(
	...
	public void setTextSize(int unit, int textSize) {
		mPaint.setTextSize((int) (TypedValue.applyDimension(unit, textSize, getContext().getResources()
				.getDisplayMetrics())));
