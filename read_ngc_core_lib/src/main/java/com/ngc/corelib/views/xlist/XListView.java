 ...
 *              load more. Implement IXListViewListener, and see stopRefresh() /
 *              stopLoadMore().
 */
...
public class XListView extends ListView implements OnScrollListener {
	...
	// 50px at bottom, trigger load more.
	...
	public void setPullLoadEnable(boolean enable) {
		...
		Logger.e("setPullLoadEnable===enable==" + enable);
		Logger.e("setPullLoadEnable===mEnablePullLoad==" + mEnablePullLoad);

		if (!mEnablePullLoad) {
			mFooterView.hide();
			Logger.e("setPullLoadEnable===mFooterView.hide==" + !mEnablePullLoad);
