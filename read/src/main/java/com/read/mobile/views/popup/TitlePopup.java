package com.read.mobile.views.popup;
...
public class TitlePopup extends PopupWindow {
	...
	public TitlePopup(Context context, int width, int height) {
		...
		// 获得屏幕的宽度和高度
		mScreenWidth = DisplayUtils.getScreenWidth((Activity) context);
		mScreenHeight = DisplayUtils.getScreenHeight((Activity) context);
		...
		mListView.setAdapter(new BaseAdapter() {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (convertView == null) {
					...
					convertView = LayoutInflater.from(mContext).inflate(R.layout.item_popup_list, null);
					viewHolder.img = (ImageView) convertView.findViewById(R.id.item_popup_img);
					viewHolder.text = (TextView) convertView.findViewById(R.id.item_popup_text);
				...
				viewHolder.img.setImageDrawable(item.mDrawable);
				return convertView;
			}
