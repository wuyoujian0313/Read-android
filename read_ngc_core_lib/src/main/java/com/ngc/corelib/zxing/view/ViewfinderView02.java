package com.ngc.corelib.zxing.view;
...
import com.ngc.corelib.zxing.camera.CameraManager;
 ...
 * 
 */
public final class ViewfinderView02 extends View {
	...
	public ViewfinderView02(Context context, AttributeSet attrs) {
		super(context, attrs);

		color = context.getResources().getColor(R.color.home_bg);
	...
	public void onDraw(Canvas canvas) {
		...
		try {
			...
			e.printStackTrace();
			Tips.tipShort(getContext(), "照相设备无访问权限");
		}
		if (frame == null) {
			return;
		}
